...
- im2patch: convert image to patches with given size and stride, and the border can be chose to keep or discard, parametersï¼?
...
- patch2im: recover image for patches with given image size, stride, and border information, parametersï¼?
  - patches: small patches, [h, w, c] for gray image; [h, w, c, p] for multi-channel
